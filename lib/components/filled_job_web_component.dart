...
import 'package:rafael_resume_cv/components/web_description_job_component.dart';
import 'package:rafael_resume_cv/utils/styles.dart';

class FilledJobWebComponent extends StatelessWidget {
  const FilledJobWebComponent({Key? key}) : super(key: key);
    ...
    return Column(
      ...
      children: [
        ...
        const Padding(
          ...
          child: WebDescriptionJobComponent(
            circularHeight: 20,
            circularWidth: 25,
            height: 260,
            width: 5,
